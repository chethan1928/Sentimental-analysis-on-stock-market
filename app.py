...
async def get_interview_feedback(session_id: str):
    ...
    # Return the stored final_feedback exactly as it was saved during session termination

    # This ensures the response is identical to what was returned when action="end" was called
